...
public partial class IslePilotVoiceLoginWindow : Window
{
    private bool _completed;
    private bool _completing;

    public IslePilotVoiceLoginWindow()
    {
        InitializeComponent();
    }

    public IslePilotVoiceAuthResult? Credentials { get; private set; }
    ...
    private async void Window_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        catch (Exception exception)
        {
            ...
            LoginStatusLabel.Text = $"Không mở được xác thực Steam: {FriendlyMessage(exception)}";
        }
    }
        ...
        CoreWebView2NavigationStartingEventArgs e)
    {
        ...
        if (!IslePilotVoiceLoginNavigationPolicy.IsAllowed(e.Uri))
        {
            e.Cancel = true;
        ...
        CoreWebView2NavigationCompletedEventArgs e)
    {
        ...
        {
            LoginStatusLabel.Text = "Trang xác thực không tải được. Kiểm tra mạng rồi bấm THỬ LẠI.";
        }
    }
    ...
    private bool TryCompleteFromCallback(string? callback)
    {
        ...
        if (!IslePilotVoiceAuthService.TryParseCallback(callback, out var credentials)
            || credentials is null)
        {
            LoginStatusLabel.Text = "IsleVOIP trả về callback không hợp lệ. Hãy thử lại.";
            return true;
        }
    ...
    private void NavigateToLogin()
    {
        ...
        BrowserLoadingPanel.Visibility = Visibility.Visible;
        LoginStatusLabel.Text = "Đang chuyển tới IsleVOIP và Steam…";
        LoginBrowser.CoreWebView2.Navigate(IslePilotVoiceAuthService.LoginUri.AbsoluteUri);
    }
